...
const LOG_LINES = [
  ...
  ['ok', 'guardrail', 'output gate passed · 0 hallucinated meds'],
  ['ok', 'retriever', 'vector hit · FAISS k=4'],
  ['info', 'router', 'model → Groq Llama 3.3 70B'],
  ['run', 'validator', 'rebuilding checklist from raw CSVs'],
  ['ok', 'react.step', 'reason → act (3/7)'],
  ['warn', 'harness', 'validation failed · retry 1/3 · feedback injected'],
  ['ok', 'eval', 'briefing graded A · coverage 100%'],
  ['run', 'sft', 'GPT-2 fine-tune · epoch 3/5'],
  ['ok', 'rag', 'ChromaDB guideline hit · source-cited ✓'],
  ['info', 'mcp', 'tool registered: patient_drug_interactions'],
